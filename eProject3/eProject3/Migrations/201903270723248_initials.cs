                ...
                c => new
                    {
                        ...
                        Aintroduction = c.String(nullable: false, maxLength: 500),
                        Aservice = c.String(nullable: false, maxLength: 500),
                    })
                .PrimaryKey(t => t.Aid);
                ...
                c => new
                    {
                        ...
                        CourseDesctiption = c.String(nullable: false, maxLength: 500),
                        ...
                        CourseImage = c.String(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        Clocation = c.String(nullable: false, maxLength: 200),
                        Caddress = c.String(nullable: false, maxLength: 200),
                        Cemail = c.String(nullable: false, maxLength: 100),
                    })
                .PrimaryKey(t => t.Cid);
                ...
                c => new
                    {
                        ...
                        Fquestion = c.String(nullable: false, maxLength: 500),
                        Fanswer = c.String(nullable: false, maxLength: 500),
                    })
                .PrimaryKey(t => t.Fid);
